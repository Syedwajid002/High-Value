...
const testimonials = [
  {
    ...
    quote: 'High value helped me find a role that perfectly matched my skills and career aspirations. The process was smooth, and I was able to connect with top companies in my industry.',
  },
  {
    id: 2,
    ...
    quote: 'After months of searching on other platforms, I found my dream job through High value within weeks. Their personalized approach and quality job listings made all the difference.',
  },
  {
    id: 3,
    name: 'Emma Chang',
    ...
    quote: 'As someone transitioning to a new career field, High value provided invaluable resources and connections. Their platform is intuitive and the support team was incredibly helpful.',
  },
];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-400 max-w-2xl mx-auto">
              Hear from professionals who found their perfect career match with High value
            </p>
          </div>
