...
const teamMembers = [
  {
    ...
    bio: 'With over 15 years in recruitment and HR tech, Jennifer founded High value to transform how companies find talent.',
  ...
  },
  {
    ...
    bio: 'David develops our marketing strategies, ensuring High value reaches both job seekers and employers effectively.',
          ...
          <div className="max-w-3xl">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                About <span className="text-secondary-400">High value</span>
              </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-neutral-700 mb-4 leading-relaxed">
                High value was founded in 2020 with a simple yet powerful vision: to create a recruitment platform that truly understands the needs of both employers and job seekers.
              </p>
              <p className="text-neutral-700 mb-4 leading-relaxed">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Today, High value has grown to serve thousands of companies and millions of job seekers worldwide, leveraging advanced technology to create meaningful connections between talent and opportunity.
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-neutral-600 text-lg">
              The principles that guide everything we do at High value
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-neutral-600 text-lg">
              Meet the experts behind High value who are passionate about connecting talent with opportunity
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12">
                ...
                <p className="text-neutral-600 mb-8">
                  Have questions about High value? We'd love to hear from you. Reach out to our team using the contact information below.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-600">contact@High value.com</p>
                    </div>
                  </div>
