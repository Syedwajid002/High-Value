                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/80">contact@High value.com</p>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative h-96 rounded-xl overflow-hidden shadow-md">
            <iframe
              ...
              loading="lazy"
              title="High value Office Location"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <FaqItem 
              question="How can I post a job on High value?"
          ...
          <div className="text-center mt-12">
            ...
            <a href="mailto:support@High value.com" className="text-primary-500 font-medium hover:underline">
